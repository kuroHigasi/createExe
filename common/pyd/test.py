...
class TestCreatePass(unittest.TestCase):
    def test_1(self):
        self.assertEqual(cPass.getImgPass("dungeon", "test", "BUTTON", 0), "dungeon\\data\\img\\test\\BUTTON\\BUTTON0.png")

    def test_2(self):
        self.assertEqual(cPass.getFontPass("DotGothic16-Regular.ttf"), "common\\data\\fonts\\DotGothic16-Regular.ttf")
...
class TestSave(unittest.TestCase):
    ...
    def test_pass_0(self):
        self.assertEqual(SAVE.PASS(), "save\\save.txt")
